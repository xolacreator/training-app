...
export const RUNNING_DOMAINS = [
  ...
  },
  {
    ...
    recovery: ['Mechanical changes redistribute load — monitor new aches.'],
  ...
  },
  {
    ...
    recovery: ['Heed early warning signs (early aches, RHR drift) — back off early.'],
  ...
  },
  {
    ...
    recovery: ['Lower mechanical variability — watch for repetitive-pattern aches.'],
